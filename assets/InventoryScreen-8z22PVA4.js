      ...
      <div class="inv-layout">
        ...
        <div class="equip-panel">
          ...
          <div class="inv-char-header">
            ${r?`<div class="inv-portrait-wrap">${Y(r,70,"inv-portrait")}</div>`:""}
            <div class="inv-char-identity">
              <div class="inv-char-name">${(r==null?void 0:r.name)||"No Character"} ${r?G(r,14,"inv-class-icon"):""}</div>
            </div>
          </div>
