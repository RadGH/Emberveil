const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/play-13DYHLpj.js","assets/modulepreload-polyfill-B5Qt9EMX.js","assets/play-dErdlDnR.css","assets/PartyScreen-BdxQc5mo.js","assets/InventoryScreen-C2ndsvGB.js","assets/ConfirmModal-ROMbuZhX.js","assets/StoryJournalScreen-C6Yc-K_h.js","assets/storyEncounterBuilder-DxmvhEAo.js","assets/storyDirector-BcZVFkew.js","assets/StoryDialogScreen-JYU76jBO.js","assets/storyMode-CYcRqQJh.js","assets/storyContent-JGlG7UiG.js","assets/storyMapGen-Bsh8haSn.js"])))=>i.map(i=>d[i]);
import{G as E,r as ae,c as C,_ as S,i as ie}from"./play-13DYHLpj.js";import{g as G,h as ne,s as oe,c as le}from"./storyMapGen-Bsh8haSn.js";import{s as de,g as F,p as ce,a as he}from"./storyDirector-BcZVFkew.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const j=Object.create(null),pe="#0c0e14";function U(n,e,s,t,r=0,i=null){if(!e)return;const a=e.backgroundOpacity??.55,o=e.backgroundDarken??.35,l=e.backgroundImage;if(ue(n,e.palette||[],s,t),!l){A(n,o,s,t);return}const h=j[e.id];if(!h){const d={img:new Image,state:"loading"};j[e.id]=d,d.img.addEventListener("load",()=>{d.state="ready",typeof i=="function"&&i()}),d.img.addEventListener("error",()=>{d.state="error"});let u="/";try{u="/Emberveil/"}catch{}d.img.src=u.replace(/\/$/,"")+"/"+l,A(n,o,s,t);return}if(h.state!=="ready"){A(n,o,s,t);return}const p=Number.isFinite(r)?Math.sin(r*.3)*4:0;n.save(),n.globalAlpha=a,n.drawImage(h.img,p-4,0,s+8,t),n.restore(),A(n,o,s,t)}function ue(n,e,s,t){const r=e.length>=2?e:["#1a1010","#0c0e14"],i=n.createLinearGradient(0,0,0,t);r.forEach((a,o)=>i.addColorStop(o/(r.length-1),a)),n.save(),n.globalAlpha=1,n.fillStyle=i,n.fillRect(0,0,s,t),n.restore()}function A(n,e,s,t){e<=0||(n.save(),n.globalAlpha=e,n.fillStyle=pe,n.fillRect(0,0,s,t),n.restore())}const me=16,Y=24,N=56,_e={combat:{color:"#c04030",label:"Combat",glyph:"⚔"},elite:{color:"#c86020",label:"Elite",glyph:"☠"},boss:{color:"#8020b0",label:"Boss",glyph:"♛"},dialog:{color:"#4080c0",label:"Dialog",glyph:"❁"},shrine:{color:"#80e0c8",label:"Shrine",glyph:"✶"},lore:{color:"#6a9040",label:"Lore",glyph:"℘"},merchant:{color:"#e0a020",label:"Merchant",glyph:"◎"},rest:{color:"#40a860",label:"Rest",glyph:"☽"},event:{color:"#9040c0",label:"Event",glyph:"✵"},waypoint:{color:"#4080c0",label:"Waypoint",glyph:"✦"},trailhead:{color:"#708050",label:"Trailhead",glyph:"⚑"},town:{color:"#c09030",label:"Town",glyph:"⌂"}},ge={color:"#806060",glyph:null},K={unexplored:"rgba(64,128,192,0.5)",discovered:"#4080c0",activated:"#40c860",corrupted:"#c04030",disabled:"#404040"},J="rgba(200,170,100,0.65)",ye="rgba(200,60,60,0.3)",fe="rgba(232,192,96,0.65)",Q=24;function be(n,e,s){const{lane:t,col:r}=n,i=[.22,.5,.78],a=r%2===0?-Q:Q,o=i[t]*s+a,h=N+r*N;return{x:Math.round(h),y:Math.round(o)}}function ve(n,e,s,t,r={},i={}){const a=_e[t]||ge,o=me,{selected:l,hovered:h,waypointState:p,visibility:d,overlay:u,state:c,recommended:m}=r;if(d==="hidden")return;const g=d==="revealed",y=c==="visited"||c==="cleared",f=g?.5:y?.55:1;if(n.save(),n.globalAlpha=f,l?(n.shadowBlur=22,n.shadowColor="#f0c040"):h&&(n.shadowBlur=10,n.shadowColor=a.color),n.beginPath(),n.arc(e,s,o,0,Math.PI*2),n.fillStyle=u==="corrupted"?"#8a2020":u==="cleansed"?"#40a860":y?we(a.color,.6):a.color,n.fill(),n.lineWidth=l?3.5:1.5,n.strokeStyle=l?"#f0c040":y?"rgba(255,255,255,0.2)":"rgba(255,255,255,0.4)",n.stroke(),l&&(n.shadowBlur=0,n.beginPath(),n.arc(e,s,o+5,0,Math.PI*2),n.strokeStyle="rgba(240,192,64,0.55)",n.lineWidth=2,n.stroke()),m&&!l&&(n.shadowBlur=0,n.beginPath(),n.arc(e,s,o+6,0,Math.PI*2),n.strokeStyle="rgba(72,209,204,0.85)",n.lineWidth=2.5,n.stroke()),p){const x=K[p]||K.unexplored;n.beginPath(),n.arc(e,s,o+4,0,Math.PI*2),n.strokeStyle=x,n.lineWidth=2,n.stroke()}const w=a.glyph||Se(t);w&&(n.fillStyle=y?"rgba(255,255,255,0.45)":"rgba(255,255,255,0.92)",n.font=`bold ${Math.round(o*.85)}px Inter, sans-serif`,n.textAlign="center",n.textBaseline="middle",n.fillText(w,e,s)),n.restore()}function we(n,e){const s=parseInt(n.slice(1,3),16),t=parseInt(n.slice(3,5),16),r=parseInt(n.slice(5,7),16),i=42,a=32,o=16,l=Math.round(s*e+i*(1-e)),h=Math.round(t*e+a*(1-e)),p=Math.round(r*e+o*(1-e));return`rgb(${l},${h},${p})`}function Se(n){return{combat:"⚔",elite:"☠",boss:"♛",dialog:"❁",shrine:"✶",lore:"℘",merchant:"◎",rest:"☽",event:"✵",waypoint:"✦",trailhead:"⚑",town:"⌂"}[n]||null}function Z(n,e,s,t,r,i,a=0){n.save();let o,l,h,p;if(i==="open"){o=J,l=2.5,h=[],p=0;const P=.55+.1*Math.sin(a*1.8+e*.01);n.globalAlpha=P}else i==="hidden"?(o=`rgba(120,80,180,${(.28+.12*Math.sin(a*3.5)).toFixed(2)})`,l=1.5,h=[5,6],p=-(a*18)%11):i==="blocked"?(o=ye,l=2,h=[4,4],p=0):i==="stitch"?(o=fe,l=2.5,h=[10,5],p=-(a*25)%15,n.shadowBlur=8,n.shadowColor="#e8c060"):(o=J,l=1.5,h=[],p=0);n.strokeStyle=o,n.lineWidth=l,n.setLineDash(h),n.lineDashOffset=p;const d=(e+t)/2,u=(s+r)/2,c=t-e,m=r-s,g=Math.sqrt(c*c+m*m)||1,y=-m/g,f=c/g,w=Math.min(12,g*.18),x=e*.6+d*.4+y*w,R=s*.6+u*.4+f*w,I=d*.4+t*.6-y*w,L=u*.4+r*.6-f*w;n.beginPath(),n.moveTo(e,s),n.bezierCurveTo(x,R,I,L,t,r),n.stroke(),n.setLineDash([]),n.globalAlpha=1,n.restore()}function xe(n,e,s,t){const r=n-s,i=e-t;return r*r+i*i<=Y*Y}const Te="story-map-screen-styles";ie(Te,`
.story-map-screen {
  position: absolute;
  inset: 0;
  display: flex;
...
`);const Ee=8,O=60,ee=150,te={emberwood:["#602010","#c84828","#e8a020","#f0d090"],stoneward:["#404850","#808090","#c0b080","#e0d8c0"],fen:["#203010","#405030","#80a040","#c0d880"],old_road:["#504030","#908060","#c0a840","#f0e0a0"],gloomridge:["#181020","#302838","#5040a0","#9080e0"],veilscar:["#200830","#401858","#8028b0","#d060f0"],_default:["#1a1210","#3a2a18","#786040","#d0b070"]};class De{constructor(e,s){this.manager=e,this.audio=s,this._el=null,this._graph=null,this._regionIdx=0,this._selectedId=null,this._canvas=null,this._ctx=null,this._panX=0,this._panStart=null,this._didPan=!1,this._rubberBand=0,this._t=0,this._raf=null,this._lastFrameMs=0,this._drawerExpanded=!1,this._drawerDragStart=null,this._nodePosCache={},this._visibilityCache=null,this._biomeData=null,this._embers=[]}onEnter(){this._build(),this._loadBiomeData().then(()=>{this._loadOrGenerateMap()}),this._startLoop(),this._playBiomeMusic()}async _loadBiomeData(){try{const s=await fetch(`${typeof import.meta<"u"&&"/Emberveil/"||"/"}assets/data/story/canonical-biomes.json`);if(s.ok){const t=await s.json();this._biomeData={};for(const r of t)this._biomeData[r.id]=r}}catch{this._biomeData={}}}_playBiomeMusic(){var e,s,t;try{const i=((e=E.get().story)==null?void 0:e.act)||1,a={1:"overworld_act1.ogg",2:"overworld_act2.ogg",3:"overworld_act3.ogg"},o=a[i]||a[1];(t=(s=this.audio)==null?void 0:s.playMusic)==null||t.call(s,o)}catch{}}onResume(){this._startLoop()}onPause(){this._stopLoop()}onExit(){this._stopLoop(),ae(this._el),this._el=null,this._canvas=null,this._ctx=null}destroy(){this.onExit()}update(){}draw(){}_loadOrGenerateMap(){var r;const e=E.get();if(!e.story)return;const s=e.story.currentMapId||"act1_map",t=e.story.act||1;if((r=e.story.maps)!=null&&r[s]){const i=e.story.maps[s].seed||e.story.campaignSeed||"default",{mapGraph:a}=G({seed:i,act:t,salt:e.story.saltOffset||0});this._graph=ne(a,e.story.maps[s])}else{const i=e.story.campaignSeed||"default",{mapGraph:a,fallbackUsed:o}=G({seed:i,act:t,salt:e.story.saltOffset||0});this._graph=a,e.story.maps||(e.story.maps={}),e.story.maps[s]=oe(a),e.story.currentMapId=a.mapId,o&&console.warn("[StoryMapScreen] Map generation failed after 10 attempts — using safety-net fallback.")}this._rebuildPosCache(),this._rebuildVisibilityCache(),this._computeDirectorRecommendation(),this._renderMap(),this._refreshTabs(),this._refreshDots()}_rebuildVisibilityCache(){var r,i,a;if(!this._graph){this._visibilityCache=null;return}const e=E.get(),s=(r=e.story)==null?void 0:r.currentMapId,t=(a=(i=e.story)==null?void 0:i.maps)==null?void 0:a[s];this._visibilityCache=le(this._graph,t)}_build(){var d;const s=((d=E.get().story)==null?void 0:d.act)||1;this._el=C("div","story-map-screen");const t=C("div","sms-topbar");t.innerHTML=`
