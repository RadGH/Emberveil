const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StatsScreen-BH9y7nAE.js","assets/play-C9WNVWr1.js","assets/savesClient-DUFjgBxb.js","assets/play-dErdlDnR.css"])))=>i.map(i=>d[i]);
import{i as l,c as n,r as o,G as p,a as d,p as c,_ as m,b as g}from"./play-C9WNVWr1.js";import"./savesClient-DUFjgBxb.js";class b{constructor(r,e){this.manager=r,this.audio=e,this.noGameMenuEsc=!0}onEnter(){l("rip-styles",f),this._el=n("div","rip-screen"),document.body.appendChild(this._el),this._render()}onExit(){o(this._el),this._el=null}destroy(){o(this._el),this._el=null}update(){}draw(){}_render(){const r=p.get(),e=r.rip||{},t=[...r.party||[],...r.companions||[]],s=e.date?new Date(e.date).toLocaleString():"—";this._el.innerHTML=`
